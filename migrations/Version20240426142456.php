 ...
 */
final class Version20240426142456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fidelite CHANGE code_promo code_promo VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE nom nom VARCHAR(255) NOT NULL, CHANGE prenom prenom VARCHAR(255) NOT NULL, CHANGE mdp mdp VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fidelite CHANGE code_promo code_promo VARCHAR(40) NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE nom nom VARCHAR(40) NOT NULL, CHANGE prenom prenom VARCHAR(40) NOT NULL, CHANGE mdp mdp VARCHAR(40) NOT NULL');
    }
}
