...
class ComandeController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        $donne=$em->findAll();
        return $this->render('base_comande.html.twig', [
            'donne' => $donne,
        ]);
    }
    ...
    #[Route('/backrechercheAjax', name: 'backrechercheAjaxC')]
    ...
    #[Route('/TriPABC', name: 'app_tri_nomComande')]
            public function Tri( ComandeRepository $commandeRepository)
            {
                $donne =  $commandeRepository->orderByNomASC();
                return $this->render("base_comande.html.twig", array( 'donne' => $donne));
            }
