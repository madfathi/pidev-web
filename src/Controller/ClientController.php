...
class ClientController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        public function show(int $idC, EntityManagerInterface $entityManager): Response
        {
    ...
    public function  edit(Request $request, $idC): Response
    {
        $prod = $this->getDoctrine()->getManager()->getRepository(Client::class)->find($idC);


        $form = $this->createForm(ClientType::class, $prod);
    ...
    #[Route('/delete/{idC}', name: 'app_client_delete', methods: ['POST'])]
    public function delete($idC, Request $request, EntityManagerInterface $entityManager): Response
    {
        $client = $entityManager->getRepository(Client::class)->find($idC);
    
        if (!$client) {
            throw $this->createNotFoundException('Client non trouvé avec l\'id: ' . $idC);
        }
