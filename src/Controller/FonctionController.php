...
//     }
     ...
     */
    public function trierSpecialite(Request $request, ClientRepository $ClientRepository): Response
    {
        // Utilisez directement la méthode trie() du repository
        $arb = $ClientRepository->trie();
 ...
 /**
     ...
     */
    public function trierSp(Request $request, ClientRepository $clientRepository): Response
    {
        // Utilisez directement la méthode trie() du repository
        $arb = $clientRepository->trieDes();
 ...
 /**
     ...
     */
    public function trierprode(Request $request, ClientRepository $clientRepository): Response
    {
        // Utilisez directement la méthode trie() du repository
        $arb = $clientRepository->trieclient();
 ...
 /**
     ...
     */
    public function searchoffreajax(Request $request, ClientRepository $clientRepository): Response
    {
        $requestString = $request->get('searchValue');

        // Utilisez directement la méthode trie() du repository
        $arb = $clientRepository->findbyNom($requestString);
