...
public function show($idP): Response
{
    $entityManager = $this->getDoctrine()->getManager();
    $program = $entityManager->getRepository(Program::class)->find($idP);
...
public function edit(Request $request, $idP, EntityManagerInterface $entityManager): Response
{
    $program = $entityManager->getRepository(Program::class)->find($idP);
    ...
    public function delete(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($request->request->get('_token') && $program) {
